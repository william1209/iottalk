...
Reg_addr = 'kkkkk' #if None, Reg_addr = MAC address

DAN.profile['dm_name']='05101751030'
DAN.profile['df_list']=['temp','humi','Dummyoutpy']   #DAN.profile['df_list']=['Acceleration', 'Dummy_Control']
